...
export const BUILDS_WATERFALL =
	'https://api.papermc.io/v2/projects/waterfall/versions/{version}/builds';
...
export const current = core.getInput('runtime').toLowerCase() || 'paper';
